...
},
{
  ...
  component: ComponentCreator('/blog/hello-world','90f'),
  exact: true,
},
{
  path: '/blog/hola',
  component: ComponentCreator('/blog/hola','1c4'),
  exact: true,
},
{
  path: '/blog/tags',
  component: ComponentCreator('/blog/tags','3a9'),
  exact: true,
},
{
  path: '/blog/tags/docusaurus',
  component: ComponentCreator('/blog/tags/docusaurus','f10'),
  exact: true,
},
{
  path: '/blog/tags/facebook',
  component: ComponentCreator('/blog/tags/facebook','1a0'),
  exact: true,
},
{
...
{
  path: '/blog/tags/hola',
  component: ComponentCreator('/blog/tags/hola','32d'),
  exact: true,
},
{
  path: '/blog/welcome',
  component: ComponentCreator('/blog/welcome','bd7'),
  exact: true,
},
{
  path: '/markdown-page',
